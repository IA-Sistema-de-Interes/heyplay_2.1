...
def main(args):
    ...
    restorer_model = GFPGANer(model_path='/content/heyplay/checkpoints/GFPGANv1.3.pth', upscale=1, arch='clean',
                              channel_multiplier=2, bg_upsampler=None)
    enhancer_model = FaceEnhancement(base_dir='/content/heyplay/checkpoints', size=512, model='GPEN-BFR-512', use_sr=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--driven_audio", default='/content/heyplay/examples/driven_audio/bus_chinese.wav',
                        help="path to driven audio")
    parser.add_argument("--source_video", default='/content/f/examples/source_image/input.mp4',
                        help="path to source video")
    parser.add_argument("--checkpoint_dir", default='/content/heyplay/checkpoints', help="path to output")
    parser.add_argument("--result_dir", default='/content/heyplay/results', help="path to output")
    ...
    parser.add_argument('--DAIN_weight', type=str, default='/content/heyplay/checkpoints/DAIN_weight',
